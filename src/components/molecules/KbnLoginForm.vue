  ...
  <form novalidate>
    <div class="form-item">
      ...
      <ul class="validation-errors">
        ...
        <li v-if="!validation.email.required">メールアドレスが入力されているません。</li>
      </ul>
    </div>
    <div class="form-item">
      ...
      <input 
        ...
        @focus="resetError">
      <ul class="validation-errors">
        <li v-if="!validation.password.required">パスワードが入力されているません。</li>
      </ul>
    </div>
...
export default {
  ...
  methods: {
    ...
    handleClick(ev) {
      if(this.disableLoginAction) { return } // Guard for preventing process if there is a defect.

      this.progress = true // This means processing login
      this.error = ''
